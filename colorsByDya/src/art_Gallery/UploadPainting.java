	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			PreparedStatement pst = (PreparedStatement) conn
					.prepareStatement("insert into painting (title, year, url, type) values(?,?,?,?)");// try2 is the
																										// name of the
																										// table
			PreparedStatement pst1 = (PreparedStatement) conn.prepareStatement("insert into painting (a_id) values(?)");// try2
																														// is
																														// the
																														// name
																														// of
