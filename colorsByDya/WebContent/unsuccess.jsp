...
<title>Error - Colors by Diyaa</title>
	...
	<link rel="stylesheet" href="./css/unsuccessPage.css" rel='stylesheet' type='text/css'>
</head>
<body>
<!-- Navbar -->
			...
			<div class="container">
				...
				<div id="navbarSupportedContent" class="collapse navbar-collapse">
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item">
							<a href="index.jsp" class="nav-link text-uppercase font-weight-bold">ERROR!</a>
						</li>
					</ul>
				</div>
			</div>
...
<div class="container p-3 my-3 rounded col-md-5" style="
	...
	<div class="container">
		<div class="row">
			<div class="col-sm">
				<p class="h5 text-left text-danger">something went wrong...!</p>
    		</div>
    		<div class="col-sm">
				<a href="index.jsp"><p class="h6 text-right text-dark pt-1">< Go back to home</p></a>
    		</div>
		</div>
	</div>
	<div class="main"> 
	...
	<center><img alt="logo" src="./pictures/Logo.png" width="100" height="100"></center>
</div>
<!-- end of Unsuccess -->
