  ...
  <div class="container">
      <div class="pt-5 text-white">
          <header class="py-5 mt-5">
              <h1 class="display-4">This is test project</h1>
              <p class="lead mb-0">Get ready gys this is the home page heshan make this</p>
              <p class="lead mb-0">LEADER Miyuru
                  <!-- <a href="https://bootstrapious.com" class="text-white">
                      <u>Bootstrapious</u></a> -->
              </p>
          </header>
          <div class="py-5">
              <p class="lead">A- <strong class="font-weight-bold">We need your ideas.we need a fixed colour </strong> if you have a any idea leave a comment in discode group <strong class="font-weight-bold">recusandae </strong>placeat! Voluptatum voluptate, ex modi illum quas nam distinctio.</p>
