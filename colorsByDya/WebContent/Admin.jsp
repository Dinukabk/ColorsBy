	...
	<div class="main-container">
		...
		<header class="block">
			...
			<div class="profile-menu">
				<p>
					ADMINISTRATION COLORS BY DIYAA <a href="#26"><span
		...
		<div class="left-container container">
			<div class="menu-box block">
				...
				<ul class="menu-box-menu">
					...
					<li><a class="menu-box-tab" href="#8"><span
							class="icon entypo-paper-plane scnd-font-color"></span>Request
							<div class="menu-box-number"></div></a></li>
					<li><a class="menu-box-tab" href="DeliverySerchTwo.jsp"><span
							class="icon entypo-calendar scnd-font-color"></span>Generate
							Delivery Report
							<div class="menu-box-number"></div></a></li>
					<li><a class="menu-box-tab" href="paymentReportDummy.jsp"><span
							class="icon entypo-cog scnd-font-color"></span>Generate Payment
							Report</a></li>
					<li><a class="menu-box-tab" href="CustomerLoginPdf.jsp"><sapn
								class="icon entypo-chart-line scnd-font-color"></sapn>Generate
							Customer Report </a></li>
					<li><a class="menu-box-tab" href="DeliverySerachThird.jsp"><sapn
								class="icon entypo-chart-line scnd-font-color"></sapn>Search
			...
			<div class="donut-chart-block block">
				...
				<div class="donut-chart">
					...
					<p class="center-date">
						MAY<br>
						<span class="scnd-font-color">2021</span>
					</p>
				</div>
			...
			<div class="line-chart-block block clear">
				...
				<ul class="month-data clear">
					<li>
						<p>
							APR<span class="scnd-font-color"> 2021</span>
						</p>
						<p>
					...
					<li>
						<p>
							MAY<span class="scnd-font-color"> 2021</span>
						</p>
						<p>
					...
					<li>
						<p>
							JUN<span class="scnd-font-color"> 20</span>
						</p>
						<p>
		...
		<div class="middle-container container">
			...
			<div class="weather block clear">
				...
				<h2 class="titular">
					<span class="icon entypo-location"></span><strong>Colombo</strong>/SRI
					LANKA
				</h2>
			...
			<div class="tweets block">
				...
				<h2 class="titular">
					<span class="icon zocial-twitter"></span>Face book Updates
				</h2>
				<div class="tweet first">
					<p>
						<a class="tweet-link" href="#17"></a>
					</p>
					<p>
						<a class="time-ago scnd-font-color" href="#18"></a>
					</p>
				</div>
				<div class="tweet">
					<p>
						<a class="tweet-link" href="#19"></a>
					</p>
					<p>
						<a class="scnd-font-color" href="#20"></a>
					</p>
				</div>
			</div>
			<ul class="social block">
				<!-- SOCIAL (MIDDLE-CONTAINER) -->
				<li><a href="www.facebook.com"><div class="facebook icon">
							<span class="zocial-facebook"></span>
						</div>
						<h2 class="facebook titular">SHARE TO FACEBOOK</h2></li>
				</a>
				<li><a href="www.twitter.com"><div class="twitter icon">
							<span class="zocial-twitter"></span>
						</div>
						<h2 class="twitter titular">SHARE TO TWITTER</h2></li>
				</a>
		...
		<div class="right-container container">
			...
			<div class="account block">
				...
				<a class="fb-sign-in" href="58">
					<p>
						<span class="fb-border"><span class="icon zocial-facebook"></span></span>Sign
						in with facebook
					</p>
				</a>
			</div>
			<div class="loading block">
				...
				<p>
					<span class="icon fontawesome-cloud-upload scnd-font-color"></span>Uploaded
				</p>
				<p class="percentage">
					43<sup>%</sup>
				</p>
			...
			<div class="calendar-day block">
				...
				<div class="arrow-btn-container">
					<a class="arrow-btn left" href="#200"><span
						class="icon fontawesome-angle-left"></span></a>
					<h2 class="titular">Thursday</h2>
					<a class="arrow-btn right" href="#201"><span
						class="icon fontawesome-angle-right"></span></a>
				</div>
				<p class="the-day">20</p>
				<a class="add-event button" href="EventUpdate.jsp">ADD EVENT</a>
			</div>
