        ...
        <div class="main-container">
            ...
            <header class="block">
                ...
                <div class="profile-menu">
                    <p>Artist Dashboard COLORS BY DIYAA <a href="#26"><span class="entypo-down-open scnd-font-color"></span></a></p>
            ...
            <div class="left-container container">
                <div class="menu-box block"> <!-- MENU BOX (LEFT-CONTAINER) -->
                    ...
                    <ul class="menu-box-menu">
                        ...
                        <li>
                            <a class="menu-box-tab" href="ArtistRetrieve.jsp"><span class="icon entypo-paper-plane scnd-font-color"></span>Artist List<div class="menu-box-number"></div></a>                            
                        </li>
                        <li>
                            <a class="menu-box-tab" href="ArtistPdf.jsp"><span class="icon entypo-calendar scnd-font-color"></span>Generate Artist Report<div class="menu-box-number"></div></a>                            
                        </li>
                        <li>
                            <a class="menu-box-tab" href="UpdateArtist.jsp"><span class="icon entypo-cog scnd-font-color"></span>Update Artist Details</a>
                        </li>
                        <li>
                            <a class="menu-box-tab" href="DeleteArtist.jsp"><sapn class="icon entypo-chart-line scnd-font-color"></sapn>Delete Artist Details </a>
                        </li>                        
                    </ul>
                </div>
