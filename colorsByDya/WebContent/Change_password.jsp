...
<html>
<head>
<title>Reset Password Form Responsive Widget Template | Home ::
	w3layouts</title>
		...
		<div class="element-main">
			...
			<form action="#" method="post">
				<input type="text" name="email" placeholder="Enter e-mail address"
					onfocus="this.value = '';"
					onblur="if (this.value == '') {this.value = 'Enter e-mail address';}">
				<input type="text" name="oldpwd" placeholder="Enter Old Password"
					onfocus="this.value = '';"
					onblur="if (this.value == '') {this.value = 'Enter Old Password';}">
				<input type="text" name="newpwd" placeholder="Enter New Password"
					onfocus="this.value = '';"
					onblur="if (this.value == '') {this.value = 'Enter New Password';}">
				<input type="text" name="cnfpwd" placeholder="Confirm Password"
					onfocus="this.value = '';"
