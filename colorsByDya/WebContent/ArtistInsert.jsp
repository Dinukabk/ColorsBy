	...
	<div id="signup">
		...
		<form action="artistinsert" method="post">
			...
			<div class="field-wrap">
				...
				</label> <input type="text" name="phone_no" />
			</div>
			...
			<div class="field-wrap">
				...
				</label> <input type="text" name="discription" />
			</div>


			<div class="field-wrap">
				<label> Address Line 1<span class="req">*</span>
				</label> <input type="text" name="add_line_01" />
			</div>
			<div class="field-wrap">
				<label> Address Line 2<span class="req">*</span>
				</label> <input type="text" name="add_line_02" />
			</div>
			<div class="field-wrap">
				<label> Postal Code<span class="req">*</span>
				</label> <input type="text" name="postal_code" />
			</div>

			<div class="field-wrap">
				<label> Province<span class="req">*</span>
				</label> <input type="text" name="province" />
			</div>
